...
export const HistoryTotalsSchema = z.object({
  ...
  "cached-input-tokens-known-requests": z.number().int().nonnegative().optional(),
  "cache-write-tokens-known-requests": z.number().int().nonnegative().optional(),
...
export const HistoryEventSchema = z.object({
  ...
  "cached-input-tokens": z.number().int().nonnegative(),
  "cache-write-tokens": z.number().int().nonnegative().default(0),
  "cached-input-tokens-known": z.boolean().optional(),
  "cache-write-tokens-known": z.boolean().optional(),
  "reasoning-tokens": z.number().int().nonnegative(),
  "total-tokens": z.number().int().nonnegative(),
